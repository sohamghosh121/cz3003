# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-03-12 16:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cms.Admin')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='first_responder', to='cms.Reporter'),
        ),
        migrations.AddField(
            model_name='event',
            name='operator',
        ...
        migrations.AddField(
            model_name='event',
            name='reporters',
            field=models.ManyToManyField(blank=True, related_name='other_responders', to='cms.Reporter'),
        ),
    ]
